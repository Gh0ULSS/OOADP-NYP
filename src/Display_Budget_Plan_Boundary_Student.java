...
public class Display_Budget_Plan_Boundary_Student extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Display_Budget_Plan_Boundary_Student frame = new Display_Budget_Plan_Boundary_Student();
	 ...
	 * Create the frame.
	 */
	public Display_Budget_Plan_Boundary_Student() {
		...
		btnDelete.setBounds(27, 407, 181, 63);
		panel.add(btnDelete);
